 ...
 * We use import.meta.glob({ eager: true }) which returns modules like { default: string }.
 * If no file exists, heroBgUrl becomes "" and we fall back to a gray background.
 */
      ...
      <main id="main" role="main">
        ...
        <section id="portfolio" className="section">
          <div className="container" style={{ padding: "40px 0" }}>
            ...
            <div style={{ marginTop: 20, borderRadius: 16, overflow: "hidden", boxShadow: "0 18px 50px rgba(15,17,21,.16)" }}>
              <img src={heroUrl} alt="Portfolio sample slide" style={{ width: "100%", aspectRatio: "16 / 9", objectFit: "cover" }} />
            </div>
          </div>
        </section>
      </main>
